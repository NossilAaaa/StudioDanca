 ...
 * @author aliss
 */
public class TelaModalidadesCM extends javax.swing.JFrame {

    PersistenciaJPA persistencia;

    public TelaModalidadesCM() {
        initComponents();
    ...
    private void btnNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovoActionPerformed
        TelaCadastroModalidades tela = new TelaCadastroModalidades(this, true); 
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaModalidadesCM().setVisible(true);
            }
        });
    }
